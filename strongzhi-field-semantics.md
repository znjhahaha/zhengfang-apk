...
Current execution is split into:

- HTML discovery for category/list/operator configuration
- API execution for list lookup and final `*Oper` submission when `dry_run=false`
